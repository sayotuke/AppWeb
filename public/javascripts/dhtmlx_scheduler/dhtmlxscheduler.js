...
scheduler._on_mouse_move = function (a) {
    if (this._drag_mode) {
        ...
        if (!this._drag_pos || b.force_redraw || this._drag_pos.x != b.x || this._drag_pos.y != b.y) {
            ...
            if (this._drag_mode == "move")if (c = this._min_date.valueOf() + (b.y * this.config.time_step + b.x * 1440 - (scheduler._move_pos_shift || 0)) *
            ...
            } else d = h.end_date.valueOf() - (h.start_date.valueOf() - c); else {
                ...
                } else c = this._drag_start; else d <=
...
scheduler._get_real_event_length = function (a, b, c) {
    ...
    if (c.render)var g = this._get_date_index(c, a), h = this._get_date_index(c, b); else h = Math.round(d / 60 / 60 / 1E3 / 24);
    for (; g < h;) {
...
scheduler._get_fictional_event_length = function (a, b, c, d) {
    ...
    if (c.render)var l = this._get_date_index(c, e), n = this._get_date_index(c, i); else n = Math.round(b / 60 / 60 / 1E3 / 24);
    for (; l * f <= n * f;) {
...
scheduler.config = {default_date: "%j %M %Y", month_date: "%F %Y", load_date: "%Y-%m-%d", week_date: "%l", day_date: "%D, %F %j", hour_date: "%H:%i", month_day: "%d", xml_date: "%m/%d/%Y %H:%i", api_date: "%d-%m-%Y %H:%i", preserve_length: !0, time_step: 5, start_on_monday: 1, first_hour: 0, last_hour: 24, readonly: !1, drag_resize: 1, drag_move: 1, drag_create: 1, dblclick_create: 1, edit_on_create: 1, details_on_create: 0, cascade_event_display: !1, cascade_event_count: 4, cascade_event_margin: 30, multi_day: !0, multi_day_height_limit: 0, drag_lightbox: !0,
    preserve_scroll: !0, select: !0, server_utc: !1, touch: !0, touch_tip: !0, touch_drag: 500, quick_info_detached: !0, positive_closing: !1, icons_edit: ["icon_save", "icon_cancel"], icons_select: ["icon_details", "icon_edit", "icon_delete"], buttons_left: ["dhx_save_btn", "dhx_cancel_btn"], buttons_right: ["dhx_delete_btn"], lightbox: {sections: [
        {name: "description", height: 200, map_to: "text", type: "textarea", focus: !0},
        {name: "time", height: 72, type: "time", map_to: "auto"}
    ]}, highlight_displayed_event: !0, left_border: !1};
scheduler.templates = {};
...
scheduler.render_data = function (a, b) {
    for (var a = this._pre_render_events(a, b), c = 0; c < a.length; c++)if (this._table_view)if (scheduler._mode != "month")this.render_event_bar(a[c]); else {
...
scheduler._pre_render_events_line = function (a, b) {
    ...
    for (var e = 0; e < a.length; e++) {
        ...
        if (this._ignores[f._sday])a.splice(e, 1), e--; else {
            c[f._sday] || (c[f._sday] = []);
            if (!b) {
                f._inner = !1;
                for (var j =
                    ...
                    if (n.valueOf() <= f.start_date.valueOf())j.splice(j.length - 1, 1); else break
                }
...
scheduler._pre_render_events_table = function (a, b) {
    ...
    for (var c = [], d = [
        ...
        if (!this._ignores[i._sday] || !i._timed) {
            ...
            if (i._sday + i._length <= g)f = null, c.push(i), q[r] = i, e[i._sweek] = q.length - 1, i._first_chunk = l.first_chunk, i._last_chunk = l.last_chunk; else {
...
scheduler._touch_events = function (a, b, c) {
    ...
    var f = navigator.userAgent.indexOf("Android") != -1 && navigator.userAgent.indexOf("WebKit") != -1, g, h, k, i, j, l, n = 0;
